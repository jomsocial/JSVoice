    ...
    <tbody>
      ...
      $k = 0; $i = 0;
			foreach ($this->rows as $row) :
				...
				$link = JRoute::_('index.php?option=com_javoice&view=tags&layout=form&task=edit&cid='.$row->id."&viewmenu=0&tmpl=component");
			?>			
      <tr class="<?php echo "row$k"; ?>">
        <td width="20" align="center"><?php echo $this->page->getRowOffset( $i ); ?></td>
        <td width="20" align="center"><?php echo $checked; ?></td>
        <td><a onclick="jaCreatForm('edit&action=tags','<?php echo $row->id?>', 700, 350,0,1,'<?php echo JText::_('EDIT_TAGS')." ".$row->name;?>');return false;" href="<?php echo $link; ?>"><?php echo $row->name;?></a></td>        
