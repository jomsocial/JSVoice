...
<form action="index.php" method="post"> 
	...
	<input type="hidden" name='id' id='id' value="<?php echo $this->id?>">
 	...
 	<input type="hidden" name="task" value="saveColor" /> 
		...
		<a><img  usemap="#colmap" src="<?php echo JURI::base()?>components/com_javoice/asset/images/colortable.gif" border=0 width=289 height=67></a><br>
		<input type="text" id='ja-class-css' value="" onmouseout="checkColor('#ja-class-css')">
		<div id='div-class-css'></div>		
		<div id='div-tranparent' onclick="tranparentColor('#ja-class-css')">
			<input type="checkbox" id="div-tranparent-box" name="div-tranparent-box">			
			<div id='div-tranparent-title'>Tranparent</div>			
		</div>
